...
func newPropertyReference(base *_object, name string, strict bool, node parser.Node) *_propertyReference {
...
func newEnvironmentReference(base _environment, name string, strict bool, node parser.Node) *_environmentReference {
...
func getIdentifierReference(environment _environment, name string, strict bool, node parser.Node) _reference {
	if environment == nil {
